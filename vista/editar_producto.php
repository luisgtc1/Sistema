...
<html lang="en">
 ...
 <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a  id="HoverSubmenus" href="registro_producto.php"><span class="glyphicon glyphicon-link" aria-hidden="true"></span>&nbsp;&nbsp;Categoria</a></li>
                <li class="divider"></li>
                <li class="dropdown-header">Otros Registros</li>
                <li><a  id="HoverSubmenus" href="registro_producto.php"><span class="glyphicon glyphicon-tower" aria-hidden="true"></span>&nbsp;&nbsp;Clientes</a></li>
           ...
           <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a  id="HoverSubmenus" href="Buscar_producto.php"><span class="glyphicon glyphicon-list" aria-hidden="true"></span>&nbsp;&nbsp;Buscar Producto</a></li>
                 <li><a  id="HoverSubmenus" href="Buscar_producto.php"><span class="glyphicon glyphicon-king" aria-hidden="true"></span>&nbsp;&nbsp;Buscar Cliente</a></li>
...
<table border="0" width="100%" align="center">
  <tr>
   ...
   <td><center> <b id="titulo_header"> Editar Producto</b></center>
    ...
    <td td width="220"> <div class="btn-group" role="group" aria-label="...">
...
<input type="text"disabled  id="reloj"name="reloj" size="10">
</form></button>

</div>
</td>
       <th width="195px" colspan="1">
