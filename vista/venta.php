...
while($fact=$stm->fetch_array()) {  ?>
        ...
        <?php  }  ?>
              ...
              <td colspan="4"><center><b>-----------------------------------------------------------------------------------------------</b></center></td>
               ...
               <tr>
              <td><h4>TOTAL</h4></td>
                <td colspan="3" id="aling_right"><h4>A PAGAR         <?php echo " $" . $total; ?> </h4></td>
               </tr>
