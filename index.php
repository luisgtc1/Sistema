...
<html lang="es"><head>
  ...
  <img id="img_index"  src="img/logo2.png" alt="">
      </form>
     <form class="form-signinp2">
  <h4>Bienvenido A Inversiones Tienda Virtual</h4>
      </form>
    ...
    <form action="seguridad/login.php" method="post"class="form-signin">
        ...
        <img src="img/login2.png" id="login"alt="">
...
?>
<center><b id="colors">sesion finalizada</b></center>
<?php 
} 
...
?>
 ...
 <b><span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span> &nbsp;&nbsp;Ingrese al Sistema</b> 
</div>
